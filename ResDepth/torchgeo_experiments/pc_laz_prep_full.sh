...
#Test to see if using full PC with projwin was different than the output cropped using gdal_translate
...
asp_stats="weighted_average min max mean median stddev count nmad"
