...
# Points that fall outside this range are classified as high noise (class 18), and are subsequently filtered out 
# by PDAL. We use a nodata value (-9999) for points that fall outside of the specified threshold
