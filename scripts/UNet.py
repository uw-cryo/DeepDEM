# 01/25/24 Copied from the ResDepth repository (https://github.com/prs-eth/ResDepth/blob/main/lib/UNet.py)
...
class UNet(nn.Module):
    def __init__(self, n_input_channels=1, start_kernel=64, max_filter_depth=512, depth=8,
                 ...
                 do_BN=True, bias_conv_layer=True, outer_skip=False, outer_skip_BN=False):
        """
